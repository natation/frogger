(function () {
  ...
  Game.prototype.setupLevel = function (level) {
    ...
    switch (level) {
      case 1:
        ...
        row5.push({className: Log, options: Game.LOG_SM});
        row5.push({className: Log, options: Game.LOG_SM});
        row5.push({className: Log, options: Game.LOG_SM});
        generateObjects.call(this, row5, Game.LOG_SM_SPACING, Game.ROW_5, 1);
  ...
  function generateObjects(objects, spacing, initY, velocity) {
