(function () {
  ...
  Util.setImages = function (images) {
    ...
    Game.TURTLE_DOWN = {img: images.froggerSprites,
                      ...
                      dims: [30, 23],
                      frames: 30};
    Game.FROG_DEAD = {img: images.frogDead,
                      dims: [180, 180],
                      gameDims: Game.FROG_DIMS};
  };
  ...
  function generateObjects(objects, spacing, initY, velocity, startPos) {
    startPos = startPos || Math.random() * Frogger.Game.DIM_X;
  ...
  Util.playSound = function (sound) {
    var audio = document.createElement("audio");
    switch (sound) {
      case "intro":
        audio.setAttribute("src", "assets/frogger_intro.mp3");
        break;
      case "hop":
        audio.setAttribute("src", "assets/frogger_hop.wav");
        break;
      case "dead":
        audio.setAttribute("src", "assets/frogger_squash.wav");
        break;
      case "init":
        audio.setAttribute("src", "assets/frogger_init.wav");
        break;
      case "success":
        audio.setAttribute("src", "assets/success.mp3");
        break;
    }
    audio.play();
  };
